  ...
  return (
    <Section className="bg-transparent relative z-10 py-16 sm:py-20">
      <Container className="text-center space-y-8">
        <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter text-[#FFFFFF]">Start With the Free Telegram Group</h2>
        <div className="space-y-6 max-w-3xl mx-auto">
          <p className="text-[#A1A1AA] text-lg leading-relaxed">
            The best way to judge Yaga Calls is to watch the free Telegram group first. Review the market notes, selected examples, and communication style. If the structure fits your trading mindset, you can compare <a href="/pricing" className="text-[#E2C896] hover:underline font-bold">premium crypto signal plans</a> later.
          </p>
        </div>

        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-center lg:text-left">
          <div className="space-y-8">
            ...
            <h1 className="text-4xl md:text-7xl font-black uppercase tracking-tighter leading-none">
              Crypto Signals for Singapore Traders
            </h1>
            <p className="text-xl text-text-muted leading-tight max-w-2xl mx-auto lg:mx-0">
              Yaga Calls provides premium Telegram-first crypto signal notes and educational market analysis for serious Singapore traders who want narrative research, risk discipline, and manual onboarding.
            </p>
            <div className="p-4 bg-primary/5 border-l-2 border-primary rounded-r-xl max-w-2xl mx-auto lg:mx-0">
              <p className="text-xs font-bold text-primary uppercase tracking-widest">
                Premium market context for traders who value structure, proof, and risk discipline.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center lg:justify-start">
              <CTAButton href={BRAND_CONFIG.officialTelegram} target="_blank" trackingLabel="singapore_hero_free">
                Join Free Telegram
              </CTAButton>
              <CTAButton href="/proof" variant="secondary" trackingLabel="singapore_hero_proof">
          ...
          <div className="relative aspect-square rounded-[40px] overflow-hidden border border-line shadow-2xl bg-black flex items-center justify-center">
             ...
             <div className="relative z-10 text-center space-y-6 p-12">
                ...
                <div className="space-y-4">
                  <div className="text-[10px] font-black uppercase tracking-[0.3em] text-primary">Singapore Trading Network</div>
                  <div className="flex flex-wrap justify-center gap-2 max-w-xs mx-auto">
                    {["CBD", "Marina Bay", "Orchard", "Singapore"].map((r) => (

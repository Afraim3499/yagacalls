          ...
          <div className="space-y-8">
            ...
            <div className="p-4 bg-primary/5 border-l-2 border-primary rounded-r-xl">
              <p className="text-xs font-bold text-primary uppercase tracking-widest">
                Dubai traders do not need louder signal groups. They need clearer market structure.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <CTAButton href={BRAND_CONFIG.officialTelegram} target="_blank" trackingLabel="dubai_hero_free">
                Join Free Telegram
              </CTAButton>
              <CTAButton href="/pricing" variant="secondary" trackingLabel="dubai_hero_pricing">
             ...
             <div className="relative z-10 text-center space-y-6 p-12">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap justify-center gap-2 max-w-xs mx-auto">
                    {["DIFC", "DMCC", "Mainland", "Free Zones"].map((r) => (

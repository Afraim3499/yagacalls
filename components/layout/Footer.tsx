        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a href="https://t.me/yagacalls" target="_blank" rel="noopener noreferrer" aria-label="Yaga Calls on Telegram" className="w-8 h-8 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:bg-amber-500 hover:border-amber-500 hover:text-black transition-all duration-300" title="Telegram Channel">
              ...
              <a href="https://x.com/Yagacalls" target="_blank" rel="noopener noreferrer" aria-label="Yaga Calls on X (Twitter)" className="w-8 h-8 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:bg-amber-500 hover:border-amber-500 hover:text-black transition-all duration-300" title="Twitter / X">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://www.binance.com/en/square/profile/square-creator-c8c5892a6ad3" target="_blank" rel="noopener noreferrer" aria-label="Yaga Calls on Binance Square" className="w-8 h-8 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-gray-400 hover:bg-amber-500 hover:border-amber-500 hover:text-black transition-all duration-300" title="Binance Square">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24">

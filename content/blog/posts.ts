...
export interface BlogPostMetadata {
  ...
  // Semantic SEO & Topic Cluster Attributes (P0)
...
export const blogPostsMetadata: BlogPostMetadata[] = [
  ...
  },
  {
    ...
    // Semantic SEO & Cluster Metadata (P0 Pillar)
    clusterId: "crypto-search-intent-2026",
    isPillarPage: true,
    searchIntent: "Informational",
    targetQuery: "crypto search intent benchmark",
    topicHierarchy: ["Analysis", "Market Research", "Search Intent Benchmark"],
    primaryEntity: {
      name: "Cryptocurrency Search Intent",
      sameAs: "https://en.wikipedia.org/wiki/Search_intent",
      description: "Empirical study measuring search engine query patterns across Canada, UAE, Nigeria, and Global markets."
    },
    secondaryEntities: [
      { name: "Google Trends", sameAs: "https://en.wikipedia.org/wiki/Google_Trends" },
  ...
  },
  {
    ...
    dateModified: "2026-08-09",
    readingTime: "10 min",
    featuredImage: "/images/canada-clarity-act-regulation.webp",
    ...
    // Semantic SEO & Cluster Metadata (P0 Spoke 1)
    clusterId: "crypto-search-intent-2026",
    isPillarPage: false,
    parentPillarSlug: "crypto-search-intent-across-markets",
    searchIntent: "Informational",
    targetQuery: "US CLARITY Act impact on Canadian crypto",
    topicHierarchy: ["Analysis", "Crypto Regulation", "CLARITY Act Canada"],
    primaryEntity: {
      name: "Digital Asset Market CLARITY Act",
      sameAs: "https://en.wikipedia.org/wiki/Financial_regulation",
      description: "US federal digital asset legislation creating international liquidity spillovers."
    },
    secondaryEntities: [
  ...
  },
  {
    ...
    dateModified: "2026-08-09",
    readingTime: "11 min",
    featuredImage: "/images/dubai-vara-crypto-licensing.webp",
    ...
    relatedPosts: ["crypto-search-intent-across-markets", "canada-crypto-regulation-clarity-act"],
    ctaLabel: "Explore Premium Signal Plans",
    ctaHref: "/pricing",

    // Semantic SEO & Cluster Metadata (P0 Spoke 2)
    clusterId: "crypto-search-intent-2026",
    isPillarPage: false,
    parentPillarSlug: "crypto-search-intent-across-markets",
    searchIntent: "Commercial",
    targetQuery: "Dubai VARA Binance crypto licensing",
    topicHierarchy: ["Analysis", "Middle East Crypto", "Dubai VARA Licensing"],
    primaryEntity: {
      name: "Virtual Assets Regulatory Authority",
      sameAs: "https://en.wikipedia.org/wiki/Economy_of_Dubai",
      description: "Dubai's official regulatory body oversight authority for virtual assets and VASPs."
    },
    secondaryEntities: [
      { name: "Binance", sameAs: "https://en.wikipedia.org/wiki/Binance" },
  ...
  },
  {
    ...
    readingTime: "10 min",
    featuredImage: "/images/nigeria-p2p-crypto-hedging.webp",
  ...
  },
  {
    ...
    metaTitle: "POLYX RWA Tokenization Breakout: 2026 Market Analysis",
    metaDescription: "Analyze the POLYX Polymesh search surge in Dubai. Learn how institutional Real-World Asset (RWA) tokenization and v8 upgrade fueled narrative attention.",
    excerpt: "POLYX (Polymesh) experienced a +5,000% Breakout in UAE search trends following its v8 upgrade. Discover how institutional RWA tokenization creates narrative momentum.",
    category: "Analysis",
    datePublished: "2026-08-09",
    dateModified: "2026-08-09",
    authorSlug: "liam-gallagher-jones",
    readingTime: "10 min",
    featuredImage: "/images/polyx-rwa-tokenization-breakout.webp",
    ...
    keywords: ["POLYX Polymesh token", "RWA tokenization crypto", "real world asset tokenization", "POLYX breakout UAE", "institutional security tokens"],
    relatedPosts: ["crypto-search-intent-across-markets", "uae-crypto-licensing-vara-binance"],
    ...
    tocItems: [
      ...
      { id: "dubai-institutional-fit", text: "Why Dubai Led POLYX Research Queries" },
      { id: "attention-vs-setup", text: "Filtering Search Anomalies into Verified setups" }
    ],
    faqs: [
      {
        question: "What is POLYX (Polymesh)?",
        answer: "POLYX is the native utility token of Polymesh, an institutional grade permissioned blockchain built specifically for regulated real-world asset (RWA) tokenization."
      },
      {
        question: "Why did POLYX search interest explode in the UAE?",
        answer: "The UAE's progressive VARA regulatory regime and high concentration of institutional family offices create ideal market conditions for compliant RWA security tokenization."
      }
    ]
  },
  {
    slug: "crypto-search-intent-funnel-guide",
    title: "The 4 Crypto Adoption Funnels: Research, Infrastructure, Access & Monitoring",
    metaTitle: "4 Crypto Search Intent Funnels: Adoption Framework Guide",
    metaDescription: "Master the 4 crypto adoption funnels: Research-to-Action, Infrastructure-to-Execution, Access-to-Transaction, and Market Monitoring.",
    excerpt: "Crypto adoption is not uniform. We unpack the 4 distinct search intent funnels across global markets and explain how traders can align setups with macro behavior.",
    category: "Education",
    datePublished: "2026-08-09",
    dateModified: "2026-08-09",
    authorSlug: "elena-soto",
    readingTime: "12 min",
    featuredImage: "/images/crypto-four-adoption-funnels.webp",
    ...
    keywords: ["crypto adoption funnels", "crypto search intent framework", "research to action crypto", "crypto market analysis guide", "global crypto behavior"],
    relatedPosts: ["crypto-search-intent-across-markets", "google-trends-crypto-narrative-trading"],
    ctaLabel: "Explore Signal Plans",
    ctaHref: "/pricing",
    tocItems: [
      { id: "four-funnels-intro", text: "Why Crypto Adoption Needs 4 Funnel Models" },
      { id: "research-to-action", text: "Funnel 1: Research-to-Action (Canada / Western Markets)" },
      { id: "infrastructure-to-execution", text: "Funnel 2: Infrastructure-to-Execution (UAE / Financial Hubs)" },
      { id: "access-to-transaction", text: "Funnel 3: Access-to-Transaction (Nigeria / Emerging Markets)" },
      { id: "market-monitoring", text: "Funnel 4: Market Monitoring (Worldwide Baseline)" }
    ],
    faqs: [
      {
        question: "What is a crypto adoption funnel?",
        answer: "A crypto adoption funnel models the sequence of search queries users execute before taking market action, ranging from educational research to exchange execution."
      },
      {
        question: "How can traders use funnel data?",
        answer: "Funnel data reveals where new capital is entering the market and whether demand is driven by speculative hype, regulatory clarity, or practical transactional utility."
      }
    ]
  },
  {
    slug: "google-trends-crypto-narrative-trading",
    title: "Google Trends for Crypto Traders: Discovering Early Market Narratives",
    metaTitle: "Google Trends Crypto Trading Guide: Find Narrative Velocity",
    metaDescription: "Learn how to use Google Trends, search breakout scores, and query intent data to discover emerging altcoin narratives before peak retail FOMO.",
    excerpt: "Discover how professional quantitative traders use Google Trends search breakout metrics to spot early narrative shifts, sector rotation, and retail FOMO waves.",
    category: "Strategy",
    datePublished: "2026-08-09",
    dateModified: "2026-08-09",
    authorSlug: "chen-wei",
    readingTime: "11 min",
    featuredImage: "/images/google-trends-narrative-discovery.webp",
    ...
    keywords: ["Google Trends crypto trading", "crypto narrative discovery", "search breakout metrics", "sector rotation signals", "altcoin momentum tracking"],
    ...
    tocItems: [
      ...
      { id: "combining-with-charts", text: "Merging Search Attention with Technical Chart Invalidation" },
      { id: "yaga-research-rules", text: "The YagaCalls Attention vs Confirmation Protocol" }
    ],
    faqs: [
      {
        question: "Does Google Trends provide real-time crypto search volume?",
        answer: "Google Trends provides relative popularity scores updated hourly or daily, making it effective for tracking multi-day narrative velocity rather than sub-minute scalping."
      },
      {
        question: "What is a 'Breakout' score in Google Trends?",
        answer: "A 'Breakout' tag means the search volume for a query increased by more than 5,000% relative to the prior baseline window."
      }
    ]
  },
  {
    slug: "cold-wallet-custody-vs-exchange-risk",
    title: "Cold Wallet Custody vs Exchange Risk: Protecting Capital in 2026",
    metaTitle: "Cold Wallet Custody vs Exchange Risk: Capital Safety Guide",
    metaDescription: "Understand exchange counterparty risk vs hardware cold wallet custody. Learn how search intent reveals user safety priorities across global markets.",
    excerpt: "Exchange counterparty risk remains a primary search category across global crypto markets. Compare hardware cold wallet custody vs exchange convenience.",
    category: "Beginner",
    datePublished: "2026-08-09",
    dateModified: "2026-08-09",
    authorSlug: "chidi-okeke",
    readingTime: "9 min",
    featuredImage: "/images/cold-wallet-custody-security.webp",
    ...
    keywords: ["cold wallet crypto custody", "hardware wallet security", "exchange counterparty risk", "self custody crypto guide", "crypto safety rules"],
    ...
    tocItems: [
      ...
      { id: "counterparty-risk", text: "Evaluating Exchange Insolvency & Regulatory Safeguards" },
      { id: "security-checklist", text: "The 5 Step Self Custody Protocol for Serious Traders" }
    ],
    faqs: [
      {
        question: "What is the safest way to store crypto?",
        answer: "An offline hardware cold wallet (such as Ledger or Trezor) with offline private key storage is widely considered the gold standard for self-custody."
      },
      {
        question: "Is it safe to leave funds on a licensed exchange?",
        answer: "While VARA-licensed or regulated exchanges provide legal safeguards, exchange storage still carries counterparty and operational risks compared to cold self-custody."
      }
    ]
  },
  {
    ...
    authorSlug: "elena-soto",
    readingTime: "10 min",
    featuredImage: "/images/fear-greed-sentiment-structure.webp",
  ...
  },
  {
    ...
    readingTime: "12 min",
    featuredImage: "/images/crv-trading-curve-price-updates.webp",
...
// Helper to query cluster relationships (P0)
export function getClusterArticles(slug: string) {
  const currentPost = blogPostsMetadata.find(p => p.slug === slug);
  if (!currentPost) return { pillarPost: undefined, spokePosts: [], siblingPosts: [], sharedEntities: [] };

  const clusterId = currentPost.clusterId;
  const isPillar = currentPost.isPillarPage;
  const parentSlug = currentPost.parentPillarSlug;

  let pillarPost = isPillar ? currentPost : (parentSlug ? blogPostsMetadata.find(p => p.slug === parentSlug) : undefined);
  if (!pillarPost && clusterId) {
    pillarPost = blogPostsMetadata.find(p => p.clusterId === clusterId && p.isPillarPage);
  }

  const spokePosts = clusterId
    ? blogPostsMetadata.filter(p => p.clusterId === clusterId && !p.isPillarPage)
    : [];

  const siblingPosts = spokePosts.filter(p => p.slug !== slug);

  const sharedEntities = [
    ...(currentPost.primaryEntity ? [currentPost.primaryEntity] : []),
    ...(currentPost.secondaryEntities || [])
  ];
...
// Helper to semantically resolve related articles (P1)
export function getRelatedPostsSemantically(slug: string, limit = 2): BlogPostMetadata[] {
  const currentPost = blogPostsMetadata.find(p => p.slug === slug);
  if (!currentPost) return blogPostsMetadata.slice(0, limit);

  // 1. Manual override takes highest priority if explicitly specified and valid
  if (currentPost.relatedPosts && currentPost.relatedPosts.length > 0) {
    const manualMatches = blogPostsMetadata.filter(p => currentPost.relatedPosts.includes(p.slug));
    if (manualMatches.length > 0) {
      return manualMatches.slice(0, limit);
    }
  }

  const { pillarPost, siblingPosts } = getClusterArticles(slug);
  const candidates: BlogPostMetadata[] = [];

  // 2. If current post is a spoke, prioritize linking to its parent pillar
  if (pillarPost && pillarPost.slug !== slug) {
    candidates.push(pillarPost);
  }

  // 3. Prioritize sibling spoke posts in the same cluster
  for (const sibling of siblingPosts) {
    if (candidates.length >= limit) break;
    if (!candidates.some(c => c.slug === sibling.slug)) {
      candidates.push(sibling);
    }
  }

  // 4. If still under limit, find posts sharing the same category or entities
  if (candidates.length < limit) {
    const categoryMatches = blogPostsMetadata.filter(p => 
      p.slug !== slug && 
  ...
  // 5. Fallback: filter remaining non-current posts
  if (candidates.length < limit) {
    const remaining = blogPostsMetadata.filter(p => 
      p.slug !== slug && !candidates.some(c => c.slug === p.slug)
    );

...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.yagacalls.com/api/og?title=Russia%20%26%20CIS%20Crypto%20Signals%20%E2%80%94%20Yaga%20Calls&subtitle=Telegram-first%20crypto%20signal%20notes%2C%20market%20narrative%20research%2C%20risk-aware%20setup%20context%2C%20selected%20proof%20examples%2C%20and%20manual%20onboarding%20for%20serious%20Russia%20and%20CIS%20traders.", width: 1200, height: 630, alt: "Russia & CIS Crypto Signals — Yaga Calls" }],
  },
  twitter: {
    ...
    title: "Russia & CIS Crypto Signals — Yaga Calls",
    description: "Telegram-first crypto signal notes, market narrative research, risk-aware setup context, selected proof examples, and manual onboarding for serious Russia and CIS traders.",
    images: ["https://www.yagacalls.com/api/og?title=Russia%20%26%20CIS%20Crypto%20Signals%20%E2%80%94%20Yaga%20Calls&subtitle=Telegram-first%20crypto%20signal%20notes%2C%20market%20narrative%20research%2C%20risk-aware%20setup%20context%2C%20selected%20proof%20examples%2C%20and%20manual%20onboarding%20for%20serious%20Russia%20and%20CIS%20traders."],
  }
};
...
export default function RussiaPage() {
  ...
  const jsonLd = {
    ...
    "@graph": [
      {
        ...createWebPageSchema({
          title: "Crypto Signals Russia | Telegram Signals for Serious Traders",
          description: "Yaga Calls provides Telegram-first crypto signal notes and educational market analysis for serious Russia and CIS traders, with risk context, proof examples, and manual onboarding.",
      ...
      },
      {
        ...createBreadcrumbSchema([
          ...
          { name: "Russia & CIS", item: "/regions/russia" }
        ]),
        "@context": undefined
      },
      {
        ...
        <Container>
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="space-y-6 text-center lg:text-left">
              <h2 className="text-2xl sm:text-[28px] md:text-[30px] font-black uppercase tracking-tighter">Does Yaga Calls Provide Signals for Russia & CIS Traders?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center pt-12">
              <div className="space-y-8">
                <h2 className="text-2xl sm:text-[28px] md:text-[30px] font-black uppercase tracking-tighter">Telegram-Native Analysis</h2>
      ...
      <Section className="bg-surface-deep border-y border-line">
        <Container>
          <div className="max-w-4xl mx-auto space-y-12 text-center">
            <h2 className="text-2xl sm:text-[28px] md:text-[30px] font-black uppercase tracking-tighter">Moscow, Saint Petersburg & CIS Coverage</h2>
      ...
      <Section className="bg-background">
        <Container className="text-center max-w-4xl space-y-12">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <CTAButton href={BRAND_CONFIG.officialTelegram} target="_blank" trackingLabel="russia_final_free">
              Join Free Telegram
            </CTAButton>

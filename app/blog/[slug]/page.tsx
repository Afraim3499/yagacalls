        ...
        <Container className="max-w-3xl">
          ...
          <div className="mt-16 pt-12 border-t border-line text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href={post.ctaHref || "https://t.me/+JFf8kBf01mg3OTg1"} target={post.ctaHref?.startsWith('http') ? "_blank" : "_self"} className="grad-button text-background px-8 py-3 rounded-xl font-bold">
